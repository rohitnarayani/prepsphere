...
const Signup = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-bg-base px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-lg bg-[#0C111C] border border-[#161E2E] p-5 sm:p-8 md:p-10 rounded-2xl shadow-xl shadow-black/40 hover:border-[#3FA9F5]/20 transition-all duration-300">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label htmlFor="branch" className="block text-sm font-semibold text-[#7587A3] mb-2">
                Branch / Discipline
              </label>
              <select
                id="branch"
            ...
            <div>
              <label htmlFor="year" className="block text-sm font-semibold text-[#7587A3] mb-2">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-2 bg-[#3FA9F5] hover:bg-[#3FA9F5]/90 hover:scale-[1.02] disabled:opacity-50 text-[#06141F] font-extrabold py-3 px-4 rounded-xl shadow-md shadow-[#3FA9F5]/15 active:scale-[0.98] transition-all flex items-center justify-center gap-2 cursor-pointer"
          >
            {loading ? (
              <>
        ...
        <p className="mt-8 text-center text-sm text-text-muted">
          ...
          <Link to="/login" className="text-[#3FA9F5] hover:text-[#3FA9F5]/80 font-semibold transition-colors">
            Sign In
          </Link>
        </p>
      </div>
